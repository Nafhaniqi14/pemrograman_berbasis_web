...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand" href="index.php">Toko Keramik</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Catalog Barang</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="proses_log_out.php" class="btn btn-danger">Logout</a>
                </li>
            </ul>
        </div>
    </div>
